  ...
  (function(cc) {
    ...
    cc.Popup = (function() {
      ...
      CookiePopup.prototype.initialise = function(options) {
        ...
        if (
          arrayContainsMatches(this.options.blacklistPage, location.pathname)
        ) {
          this.options.enabled = false;
        }
        if (
          arrayContainsMatches(this.options.whitelistPage, location.pathname)
        ) {
      ...
      CookiePopup.prototype.isOpen = function() {
        return (
          ...
          this.element.style.display == '' &&
          (cc.hasTransition
            ? !util.hasClass(this.element, 'cc-invisible')
            : true)
        );
      };
      ...
      function addCustomStyle(hash, palette, prefix) {
        ...
        if (popup) {
          ...
          if (button) {
            ...
            if (button.padding) {
              colorStyles[prefix + ' .cc-btn'].push(
